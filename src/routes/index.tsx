...
const dict = {
  en: {
    ...
    nav: { impact: "Impact", story: "Story", learning: "Learning", convergence: "Convergence", resilience: "Resilience", contact: "Contact" },
  ...
  hi: {
    ...
    foundation: "फाउंडेशन",
    nav: { impact: "प्रभाव", story: "कहानी", learning: "शिक्षा", convergence: "अभिसरण", resilience: "सहनशीलता", contact: "संपर्क" },
